config = {
    ...
    "remarks":['Direction of a toponym in the form of an arrow', 
               ...
               'Information_Board_Street_Name_Green_M', 'Information_Parking_for_Disable_M', 'Mandatory passage from the left side of the island', 
               'Mandatory passage from the right or left side of the island', 'Mandatory passage from the right side of the island', 'Caution_Bidirectional_Traffic_M', 
