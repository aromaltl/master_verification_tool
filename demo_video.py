...
assets_dic={}
videos=list(glob.glob("/run/user/1000/gvfs/afp-volume:host=Anton.local,user=ml_support,volume=MachineLearning/POC/KSA Aramco/lhs/*.MP4"))
videos.sort()
counter={}
...
writer = cv2.VideoWriter("out_lhs.MP4", fourcc, 30, (w, h))
